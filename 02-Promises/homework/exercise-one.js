...
function problemA () {
  ...
  var filepath = './poem-one/stanza-01.txt';

  promisifiedReadFile(filepath)
  .then(r => blue(r))
  // .then(function (contents){
  //   blue(contents.toString());
  // }, function (err){
  //   console.error(err);
  // });
}
...
function problemB () {
  ...
  var filepath2 = './poem-one/stanza-02.txt';
  var filepath3 = './poem-one/stanza-03.txt';

  
  promisifiedReadFile(filepath2)
  .then(r2 => {blue(r2)})
  promisifiedReadFile(filepath3)
  .then(r3 => {blue(r3)})

  // promisifiedReadFile(filepath2)
  // .then(function (contents){
  //   console.log(magenta(contents.toString()));
  // }, function (err){
  //   console.error(err);
  // });
  // promisifiedReadFile(filepath3)
...
function problemC () {
  ...
  .then(r2 => {
    blue(r2)
    return promisifiedReadFile(filepath3)
  })
  .then(r3 => {blue(r3)})
  console.log('done')
...
function problemD () {
  ...
  // promise version
  // ???
  var filepath4 = 'poem-one/wrong-file-name.txt';
  promisifiedReadFile(filepath4)
  .then(r => {blue(r)},
...
function problemE () {
  ...
  promisifiedReadFile(filepath3)
  .then(r => {blue(r)
              return promisifiedReadFile(filepath4)
  })
  .then(r2 => {blue(r2)})
  .catch(r3 => {magenta(new Error(r3))})
}
